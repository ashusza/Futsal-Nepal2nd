    ...
    <>
      ...
      >
        <div className="h-full px-6 md:px-12 flex items-center justify-between max-w-[1920px] mx-auto">
          {/* Logo */}
          <div className="flex items-center gap-1 font-heading text-2xl tracking-widest">
          ...
          <div className="hidden md:block">
            <button className="group relative bg-primary text-white font-heading text-sm tracking-[0.1em] px-6 py-2 [clip-path:polygon(0_0,calc(100%-12px)_0,100%_100%,0_100%)] hover:scale-[1.02] transition-transform duration-300">
